...
//       // Manually sanitize and simplify the 'eyeware_type' field
//       const sanitizedTypes = await Promise.all(
...
//           // Check if eyeware_type exists and has a name, then simplify it
//           if (sanitized.eyeware_type && sanitized.eyeware_type.name) {
//             sanitized.eyeware_type = sanitized.eyeware_type.name;
//           } else {
//             sanitized.eyeware_type = null;
//           }
